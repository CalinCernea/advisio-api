...
<div style="font-family:Georgia,serif;font-size:18px;font-weight:600;color:#ffffff;">Advisio</
<div style="font-size:9px;font-family:Helvetica,Arial,sans-serif;letter-spacing:0.12em;</td>
</tr>
<!-- BODY -->
<tr>
...
<p style="font-family:Helvetica,Arial,sans-serif;font-size:14px;color:rgba(255,255,255,0.6);Bună {first_name},<br><br>
...
<a href="{audit_url}" style="font-family:Helvetica,Arial,sans-serif;font-size:14px;↓ Descarcă Auditul Complet (PDF)
</a>
</td>
</tr>
</table>
<p style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:rgba(255,255,255,0.4);Auditul include: diagnosticul complet al prezenței digitale, cele 5 pierderi de timp
...
<!-- FOOTER -->
<tr>
<td style="background:#0f1b2d;border-radius:0 0 14px 14px;padding:20px 36px;border-top:1px <p style="font-family:Helvetica,Arial,sans-serif;font-size:11px;color:rgba(255,255,255,0.3);Advisio AI Audit · 2026
</p>
</td>
</tr>
</table>
...
# Descarcă PDF-ul de pe Drive pentru atașament
...
part.add_header("Content-Disposition", f'attachment; filename="Audit_Advisio_{safe_msg.attach(part)
except Exception as e:
